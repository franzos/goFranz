...
title: "Work With Me"
layout: page
description: "A senior identity and systems engineer for hire: digital identity, verifiable credentials, backend architecture, and AI where a wrong answer has consequences. Selective, EU-based."
keywords: "freelance identity engineer, OIDC OAuth developer for hire, verifiable credentials engineer, senior backend architect Europe, custom AI integration Europe, EU AI Act, AI security review, prompt injection testing, LLM security audit"
permalink: /work-with-me/
---

I take on a small number of outside engagements a year. The core is identity and systems work; some of it is AI. Anyone can wire up an OIDC login now; the value was never the protocol, it's judgment: knowing what to build, what it costs you later, and when the confident answer is wrong. In every case the same thing is true: the problem is real, the domain is one I know, and getting it wrong is expensive. Here's what I take on.
...
- **Compliance as an output.** GDPR and EU AI Act posture handled as part of the engagement: risk classification, audit logging, disclosure copy, post-market monitoring scaffold. (More on what "aligned" means in [this post](/blog/iso-27001-42001-what-aligned-actually-means/).)
...
The [resume](/resume/) has the longer version, and [selected work](/work/) has the projects.
...
Tell me what you're building and where it's stuck. I'll tell you honestly whether I'm the right person for it. [Drop me a line](/contact/) or reach out on [WhatsApp](https://wa.me/351920739996?text=Hi%20Franz,%20I%27d%20like%20to%20talk%20about%20a%20project).
